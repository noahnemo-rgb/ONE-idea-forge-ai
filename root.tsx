...
import { SessionContext, SessionProvider } from '@auth/create/react';
...
class SoftSessionBoundary extends Component<{ children: ReactNode }, { failed: boolean }> {
  state = { failed: false };
...
function SoftSession({ children }: { children: ReactNode }) {
  return (
    <SoftSessionBoundary>
